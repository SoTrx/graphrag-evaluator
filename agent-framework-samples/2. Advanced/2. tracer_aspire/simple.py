...
async def main():
    async with (
        ...
        # Alternatively, you can enable OpenTelemetry tracing without Azure AI integration.
        # This is useful for local development or if you don't have an Azure AI project.
        # setup_observability(
        #     enable_sensitive_data=True,
        #     otlp_endpoint="http://localhost:4317" OR
        #     applicationinsights_connection_string="InstrumentationKey=your_instrumentation_key",
        #     vs_code_extension_port=4317)

        # Alternatively, you can enable OpenTelemetry tracing based on environment variables.
        # This is useful for configuring tracing without changing code.
        # setup_observability() <= Only this line is enough
        ...
        # Alternatively, you can configure OpenTelemetry exporters directly.
